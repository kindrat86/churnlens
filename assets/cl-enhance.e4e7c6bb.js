    ...
    form.addEventListener('submit', async function(e) {
      ...
      try {
        var resp = await fetch('/api/subscribe', {
          ...
          // Browser IANA tz -> Resend contact last_name 'tz:<IANA>'; the drip
          // engine (engine.py _contact_tz) reads it to gate sends to this
          // lead's local business hours. Resend only persists name fields.
